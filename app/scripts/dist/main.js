...
var userStore = new _storage.UserStore('x-anonychat/u');
...
var ChatMessage = function () {
  function ChatMessage(data) {
    ...
    var m = data.message,
        ...
        u = _data$user === undefined ? username : _data$user,
...
},{"./dom.js":2,"./storage":4,"./ws-client":5}],2:[function(require,module,exports){
'use strict';
...
var ChatList = exports.ChatList = function () {
  function ChatList(listSel, username) {
    ...
    this.$listSel = (0, _jquery2.default)(listSel);
  ...
  _createClass(ChatList, [{
    ...
    value: function drawMessage(_ref) {
      ...
      var $img = this.randomImg();

      $messageRow.append($img);
      $messageRow.append($message);
      (0, _jquery2.default)('ul').append($messageRow);
